...
public class ModifyProductController implements Initializable {
    ...
    /**
     * Part object is added selected to table of associated parts.
     *
    ...
    private void displayAlert(int alertType) {
        ...
        switch (alertType) {
            case 1:
                ...
                alert.setHeaderText("Could Not Modify Product");
                alert.setContentText("A field is blank or value is invalid.");
                alert.showAndWait();
                break;
            case 2:
